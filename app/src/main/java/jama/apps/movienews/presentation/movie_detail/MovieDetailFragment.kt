package jama.apps.movienews.presentation.movie_detail
...
import jama.apps.movienews.data.changeMoneyType
import jama.apps.movienews.data.formatDate
import jama.apps.movienews.data.runtimeToHM
import jama.apps.movienews.databinding.FragmentMovieDetailThirdBinding
import jama.apps.movienews.presentation.BaseFragment
import jama.apps.movienews.presentation.YoutubeActivity
import jama.apps.movienews.presentation.adapter.CastAdapter
import jama.apps.movienews.presentation.adapter.GenreListMiniAdapter
import jama.apps.movienews.presentation.adapter.MovieTrailerAdapter
