...
import jama.apps.movienews.data.movie_detail.model.remote.response.MovieTrailerResponse
import jama.apps.movienews.databinding.ItemMovieTrailerFullBinding
