package jama.apps.movienews.presentation.genres_list
...
import jama.apps.movienews.databinding.FragmentGenresListBinding
import nl.joery.animatedbottombar.AnimatedBottomBar
import jama.apps.movienews.presentation.BaseFragment
import jama.apps.movienews.presentation.adapter.GenreListAdapter
import jama.apps.movienews.presentation.genre.GenreViewModel
    ...
    override fun onViewCreate() {
        ...
        adapterTV.setItemClickListener { id, name ->
            ...
            navController.navigate(
                R.id.action_navigation_genre_to_genreTVFragment,
                bundle)
        }
